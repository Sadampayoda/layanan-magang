...
<div>
    ...
    <nav class="sidebar-nav scroll-sidebar no-scrollbar" data-simplebar="">
        ...
        <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link {{ ($title == 'program') ? 'active' : '' }} text-decoration-none" href="">
                    <i class="bi bi-clipboard-check fs-4"></i>
                    <h3 class="fs-4 mt-1">Program</h3>
                </a>
            </li>
            <li class="sidebar-item">
                <a class="sidebar-link {{ ($title == 'kegiatan') ? 'active' : '' }} text-decoration-none" href="">
                    <i class="bi bi-calendar-check fs-4"></i>
                    <h3 class="fs-4 mt-1">Kegiatan</h3>
                </a>
            </li>
            <li class="sidebar-item">
                <a class="sidebar-link {{ ($title == 'notifikasi') ? 'active' : '' }} text-decoration-none" href="">
